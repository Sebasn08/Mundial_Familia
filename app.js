...
function resolveUserR32(pred){
  ...
  // ANTES: el tercero N°1 del ranking iba siempre al slot "3#1", el N°2 a "3#2", etc.
  // Eso no es lo que dice el reglamento: el cruce depende del GRUPO de cada tercero,
  // no de su posición en el ranking. Usamos la tabla oficial (Anexo C) para mapear
  // los 8 grupos clasificados a su cruce real.
