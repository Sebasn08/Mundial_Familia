...
async function renderLeaderboard(){
  ...
  // Cabecera
  html += '<div class="leader-row leader-header" style="font-size:11px;color:var(--muted);text-transform:uppercase;letter-spacing:.06em;border-bottom:2px solid var(--line);padding-bottom:6px;margin-bottom:4px;">';
  html += '<div class="rank">#</div>';
  html += '<div class="name">Nombre</div>';
  html += '<div class="pts-cell" style="text-align:right;font-weight:700;color:var(--pitch);">Total</div>';
  html += '<div class="pts-cell">Partidos</div>';
  html += '<div class="pts-cell">Clasif.</div>';
  html += '<div class="pts-cell">3eros</div>';
  KNOCKOUT_ROUNDS.forEach(r=>{
    html += '<div class="pts-cell">'+ROUND_LABELS[r.key]+'</div>';
  });
  html += '</div>';
  ...
  results.forEach((r, idx)=>{
    ...
    html += '<div class="pts-cell total">'+r.total+'</div>';
    html += '<div class="pts-cell">'+gruposPartidos+'</div>';
    html += '<div class="pts-cell">'+b.clasificados+'</div>';
    html += '<div class="pts-cell">'+b.terceros+'</div>';
    KNOCKOUT_ROUNDS.forEach(rnd=>{
      html += '<div class="pts-cell">'+(b.rounds[rnd.key]||0)+'</div>';
    });
    html += '</div>';
  });
  html += '</div>';
