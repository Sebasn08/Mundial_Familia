...
function renderPredKnockoutForm(){
  ...
  html += '<div id="predBracketTree">'+buildBracketTreeHtml(bracket, {editable:true, thirdPicks: pred.thirdPicks||{}})+'</div>';
...
function wireBracketInputs(container, pred){
  ...
  treeEl.querySelectorAll("input.bpred").forEach(inp=>{
    inp.addEventListener("change", ()=>{
      ...
      const bracket = computeUserBracket(pred);
      treeEl.innerHTML = buildBracketTreeHtml(bracket, {editable:true, thirdPicks: pred.thirdPicks||{}});
