...
async function renderLeaderboard(){
  ...
  let html = '<div class="card" style="padding:18px 0;">';
  html += '<div class="leaderboard-scroll">';
  // Cabecera
  html += '<div class="leader-row leader-header">';
  html += '<div class="rank">#</div>';
  html += '<div class="name">Nombre</div>';
  html += '<div class="pts-cell total">Total</div>';
